...
async function main() {
  ...
  try {
    ...
    if (libraries.ChatOpenAI) {
      ...
      console.log(
        "❌ LangChain OpenAI is not available (library not installed)",
      );
      console.log(
        "   📦 Install with: npm install @langchain/openai @langchain/core",
      );
    }
    ...
    if (libraries.ChatAnthropic) {
      ...
      console.log(
        "❌ LangChain Anthropic is not available (library not installed)",
      );
      console.log(
        "   📦 Install with: npm install @langchain/anthropic @langchain/core",
      );
    }
  } catch (error) {
