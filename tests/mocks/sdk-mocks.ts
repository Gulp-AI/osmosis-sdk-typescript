...
export const mockAnthropicRequest = jest.fn().mockResolvedValue({
  ...
  role: 'assistant',
  content: [
    { type: 'text', text: 'This is a mock response' }
  ],
...
export const mockLangchainOpenAIGenerate = jest.fn().mockImplementation(async (messages, options) => ({
  generations: [[{ 
...
export class MockChatOpenAI {
  ...
  _generate = (messages: any, options: any) => mockLangchainOpenAIGenerate(messages, options);
  ...
  stream = jest.fn().mockImplementation(async function* (messages: any[]): AsyncGenerator<AIMessageChunk> {
...
export const mockLangchainAnthropicGenerate = jest.fn().mockImplementation(async (messages, options) => ({
  generations: [[{ 
...
export class MockChatAnthropic {
  ...
  // Add the _generate method
  _generate = (messages: any, options: any) => mockLangchainAnthropicGenerate(messages, options);
